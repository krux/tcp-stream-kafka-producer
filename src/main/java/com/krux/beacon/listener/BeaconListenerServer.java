...
public class BeaconListenerServer {
    ...
    public static void main(String[] args) {
        ...
        OptionSpec<String> portTopicMappings = parser.accepts("portTopic", "The port->topic mappings").withOptionalArg()
                .ofType(String.class);

        OptionSpec<String> option2 = parser.accepts("option2", "The port->topic mappings").withOptionalArg()
                .ofType(String.class);
